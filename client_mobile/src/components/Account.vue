    ...
    <v-layout row wrap justify-center>
      ...
      <v-flex v-if="showTotalContent" xs12 class="text-xs-center" mt-1>
        ...
        <!-- R O W 1 -->   
          ...
          <v-flex xs1 order-xs2/>
          
          <v-flex xs5 order-xs2>
            <v-menu
              :close-on-content-click="false"
              v-model="menu2"
              :nudge-right="40"
        ...
        <v-layout row ma-2 justify-center>          
          <v-flex xs12 order-xs2>
             <v-radio-group v-model="row" row>
              ...
              <v-radio label="자재관리" value="radio-item" @change='radioChanged'></v-radio>
  ...
  data () {
    return {
      ...
      headersForCOO: [
        ...
        { text: '품목', sortable: false, value: 'category' },
        { text: '금액', sortable: false, value: 'cost' }
        //  { text: '상세', value: 'name', sortable: false, align: 'left', width: '5%' }
      ],
      row: 'radio-total',
      ...
      headersForInc: [
        ...
        //  { text: '농장명', sortable: false, value: 'landName' },
        { text: '항목', sortable: false, value: 'cropName', width: '30%' },
        //  { text: '내역', sortable: false, value: 'income.detail' },
        { text: '금액', sortable: false, value: 'income.amount', width: '40%' }
        // { text: '상세', value: 'name', sortable: false, align: 'left', width: '5%' }
      ],
      //
      totalIncMinusExp: 0,
