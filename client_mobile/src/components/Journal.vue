                  ...
                  <div style="width:100%; margin:0 auto;">
                    ...
                    >
                      ...
                      <template slot="items" slot-scope="props">                        
                        ...
                        <td :style="{backgroundColor: (props.index % 2 ? '#F6F7FE' : 'transparent')}" @click="showItem(props.item)"><h5>{{ props.item.date }}</h5></td>
                        <td :style="{backgroundColor: (props.index % 2 ? '#F6F7FE' : 'transparent')}" @click="showItem(props.item)"><h5>{{ props.item.workName }}</h5></td>                                                     
                      </template>
                    </v-data-table>
                    <div class="text-xs-center pt-2">
